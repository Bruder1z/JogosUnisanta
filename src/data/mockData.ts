...
export interface MatchEvent {
  id: string;
  type: 'goal' | 'yellow_card' | 'red_card' | 'start' | 'end' | 'set_win' | 'halftime' | 'penalty_scored' | 'penalty_missed';
  minute: number;
...
export const COURSE_EMBLEMS: Record<string, string> = {
  ...
  'Odontologia - São Judas': 'odonto-sao judas.png.png',
...
export const mockRanking: RankingEntry[] = [
  ...
  { rank: 38, course: 'FAAC - Unisanta',                  points: 0   },
