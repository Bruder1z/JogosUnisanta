...
export const COURSE_EMBLEMS: Record<string, string> = {
  ...
  "Análise de Sistemas - Fatec": "Anali Sist-Fatec.jpg",
  "Análise de Sistemas - Unip": "ANALI SIST UNIP.jpg",
  "Biologia - Unisanta": "biologia-unisanta.png.png",
  "Biomedicina - Unisanta": "biomedicina-unisanta.png.png",
  "Ciência de Dados - Fatec": "Cien Dados-Fatec.jpg",
  "Comex - Unisanta": "comex-unisanta.jpg",
  "Comunicação - Esamc": "comunicacao_esamc.jpg",
  ...
  "Psicologia - Unisantos": "psicologia_unisantos.jpg",
  "Rel. Internacionais - Unisanta": "rel-internacionais- unisanta.png.jpg",
  // "Saúde - Unisantos": "saude-unisantos.png.png", // Arquivo não existe
  "Sistemas de Informação - Unisanta": "sistemas.png.png",
  "Tec. Inf. - Esamc": "tecno info-esamc.png",
  "Tec. Inf. - Unisantos": "ti unisantos.png",
  "Terapia Ocupacional - Unisanta": "terapia-ocupacional.jpg",
};
...
export const mockRanking: RankingEntry[] = [
  ...
  { rank: 46, course: "Comunicação - Esamc", points: 0 },
  { rank: 47, course: "Psicologia - Unisantos", points: 0 },
  { rank: 48, course: "Tec. Inf. - Esamc", points: 0 },
  { rank: 49, course: "Terapia Ocupacional - Unisanta", points: 0 },
  { rank: 50, course: "Análise de Sistemas - Fatec", points: 0 },
  { rank: 51, course: "Ciência de Dados - Fatec", points: 0 },
  { rank: 52, course: "Comex - Unisanta", points: 0 },
];
